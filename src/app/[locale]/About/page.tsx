  ...
  return (
    <div className="container mx-auto max-w-6xl px-6 py-12">
      ...
      <section className="mb-16 bg-white p-8 rounded-lg shadow-lg">
        ...
        <p className="text-lg text-gray-700 mb-6 max-w-2xl">{t("missionDescription")}</p>

        <h2 className="text-2xl font-semibold text-gray-800 mb-4">
          {t("visionTitle")}
        </h2>
        <p className="text-lg text-gray-700 max-w-2xl">{t("visionDescription")}</p>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            ...
            >
              ...
              <p className="mt-2 text-center text-gray-700">{capability.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-16 bg-white p-8 rounded-lg shadow-lg">
        ...
        <p className="text-lg text-gray-700 mb-6 max-w-2xl">{t("locationDescription")}</p>
      ...
      <section className="text-center">
        ...
        <p className="text-lg text-gray-700 max-w-2xl mx-auto">{t("extraInfoDescription")}</p>
      </section>
    </div>
  );
}
