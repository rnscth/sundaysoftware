    ...
    {/* // <div className="container mx-auto p-8 bg-gradient-to-b from-gray-900 to-gray-800 min-h-screen flex flex-col items-center"> */}
      ...
      <section className="mt-8 text-center">
        ...
        <div className="flex justify-center gap-6 mt-4">
          <a href="mailto:Sunday.Software.Solutions@gmail.com" className="flex items-center gap-2 text-primary hover:text-primary-light transition">
            <AiOutlineMail size={24} /> Sunday.Software.Solutions@gmail.com
          </a>
          <a href="https://wa.me/+526865254888" className="flex items-center gap-2 text-green-500 hover:text-green-400 transition">
            <FaWhatsapp size={24} /> +52 686 525 4888
          </a>
        </div>
      </section>
